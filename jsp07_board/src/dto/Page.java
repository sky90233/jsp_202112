...
public class Page {
	...
	public String toString() {
		return "Page [curpage=" + curpage + ", totpage=" + totpage + ", perpage=" + perpage + ", startnum=" + startnum
				...
				+ ", findkey=" + findkey + ", findvalue=" + findvalue + ", getCurpage()=" + getCurpage()
				+ ", getTotpage()=" + getTotpage() + ", getPerpage()=" + getPerpage() + ", getStartnum()="
				+ getStartnum() + ", getEndnum()=" + getEndnum() + ", getPerblock()=" + getPerblock()
				+ ", getStartpage()=" + getStartpage() + ", getEndpage()=" + getEndpage() + ", getFindkey()="
				+ getFindkey() + ", getFindvalue()=" + getFindvalue() + ", getClass()=" + getClass() + ", hashCode()="
