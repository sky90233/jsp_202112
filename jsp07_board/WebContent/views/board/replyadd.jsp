...
<body>
	...
	<form name="frmReply" action="${path}/reply/add" method="post">
		부모그룹번호<input type="text" value="${param.ref}" name="ref" size="2">
		부모글순서<input type="text" value="${param.restep}" name="restep" size="2">
		부모글레벨<input type="text" value="${param.relevel}" name="relevel" size="2">
		<table border="1">
			<tr>
				<th>이메일</th>
